...
@dso_cache = dso_local local_unnamed_addr global [594 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 346983902, ; hash 0x14ae8dde, from name: aot-EmployeeData.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 413942632, ; hash 0x18ac4368, from name: libaot-EmployeeData.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EmployeeData.dll.so
		ptr null; void* handle (0x0)
	}, ; 54
	...
	%struct.DSOCacheEntry {
		i64 1648598211, ; hash 0x62439cc3, from name: aot-EmployeeData
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EmployeeData.dll.so
		ptr null; void* handle (0x0)
	}, ; 221
	...
	%struct.DSOCacheEntry {
		i64 2125221932, ; hash 0x7eac502c, from name: EmployeeData.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EmployeeData.dll.so
		ptr null; void* handle (0x0)
	}, ; 299
	...
	%struct.DSOCacheEntry {
		i64 2484983236, ; hash 0x941dd5c4, from name: libaot-EmployeeData
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EmployeeData.dll.so
		ptr null; void* handle (0x0)
	}, ; 357
	...
	%struct.DSOCacheEntry {
		i64 3451898196, ; hash 0xcdbfc954, from name: EmployeeData
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EmployeeData.dll.so
		ptr null; void* handle (0x0)
	}, ; 489
